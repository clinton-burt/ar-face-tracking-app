...
FxEaglesMilitaryHat::FxEaglesMilitaryHat()
{
	...
	model->name = "hat";
	model->modelPath = "./assets/fx/eagles/military_hat/Eagles_MilitaryHat.obj";
	model->texturesPaths.fill( {		
		"./assets/fx/eagles/military_hat/tex/EaglesHat_Military_ColorMap.jpg",
		"./assets/fx/eagles/military_hat/tex/HatBrimm_Color_camou.png",
		"./assets/fx/eagles/military_hat/tex/USFLAG.png"		
	});
...
void FxEaglesMilitaryHat::transform(FXModel& face, ExternalRenderParams &externalRenderParams)
{
