#include <fx/FxFootballTeamHelmet.h>

FxFootballTeamHelmet::FxFootballTeamHelmet()
{
	//loadFromJSON("./assets/fx_config/filter-modules/football-helmet-modules-chargers.json");
	//loadFromJSON("./assets/fx_config/filter-modules/football-helmet-modules-eagles.json");
	...
	model->texturesPaths.fill({
		"./assets/fx/nfl_teams/textures/chargers/Helmet_V5_HelmetStripe_UVMap.jpg",
		"./assets/fx/nfl_teams/textures/chargers/Helmet_V5_FaceMask_UVMap.jpg",
		"./assets/fx/nfl_teams/textures/chargers/Helmet_V5_Helmet_UVMap.jpg"
	});
	model->name = "helmet";
