...
FxPhilliesHat::FxPhilliesHat()
{
	...
	model->name = "hat";
	model->modelPath = "./assets/fx/phillies/philliesHat/baseball_cap_with_logo.obj";
	model->texturesPaths.fill({
		"./assets/fx/phillies/philliesHat/baseball_cap_texture.jpg",
		"./assets/fx/phillies/philliesHat/p.png"
	});
...
void FxPhilliesHat::transform(FXModel& face, ExternalRenderParams &externalRenderParams)
{
